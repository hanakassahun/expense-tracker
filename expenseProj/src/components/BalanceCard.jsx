  ...
  return (
    ...
    >
      <div className="text-center">
        <div className="gradient-bg p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.div 
            className="text-center p-3 rounded-lg bg-success-50 dark:bg-success-900/20 shadow-sm"
          ...
          <motion.div 
            className="text-center p-3 rounded-lg bg-danger-50 dark:bg-danger-900/20 shadow-sm"
            whileHover={{ scale: 1.06 }}
            transition={{ duration: 0.18, ease: 'easeInOut' }}
          >
            <div className="flex items-center justify-center mb-1">
